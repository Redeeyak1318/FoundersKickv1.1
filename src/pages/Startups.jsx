                ...
                >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <input
                            ...
                            className="bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white text-sm outline-none focus:ring-1 focus:ring-rose-500/50"
                        ...
                        <input
                            ...
                            className="bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white text-sm outline-none focus:ring-1 focus:ring-rose-500/50 md:col-span-2"
                            placeholder="One-line tagline"
                        />
                        <input
                            type="text"
                            value={newStartup.tags}
                            onChange={(e) => setNewStartup(prev => ({ ...prev, tags: e.target.value }))}
                            className="bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white text-sm outline-none focus:ring-1 focus:ring-rose-500/50 md:col-span-2"
                            placeholder="Tags (comma-separated, e.g. #AI, #B2B)"
                        />
                    </div>
                    <button
                        onClick={handleCreate}
                        disabled={creating || !newStartup.name.trim()}
                        className="accent-gradient px-6 py-2.5 rounded-xl text-white font-semibold text-sm hover:opacity-90 transition-opacity disabled:opacity-50 flex items-center gap-2"
                    >
