    ...
    useEffect(() => {
        ...
        const initApplication = async () => {
            ...
            const slides = [
                {
                    title: "FoundersKick",
                    description: "Where founders connect, commit, and collaborate.",
                    media: SLIDER_CONFIG.media[0],
                },
                {
                    title: "Connect",
                    description: "The world’s founders, builders, and visionaries — in one intelligent network.",
                    media: SLIDER_CONFIG.media[1],
                },
                {
                    title: "Commit",
                    description: "Momentum begins when ideas find belief. Energy moves when founders move.",
                    media: SLIDER_CONFIG.media[2],
                },
                {
                    title: "Collaborate",
                    description: "Startups form. Teams align. Products launch.",
                    media: SLIDER_CONFIG.media[3],
                },
                {
                    title: "Build the future together",
                    description: "FoundersKick — Connect. Commit. Collaborate.",
                    media: SLIDER_CONFIG.media[4],
                },
                {
                    title: "About",
                    description: "A platform built for modern founders worldwide.",
                    media: SLIDER_CONFIG.media[5],
                },
            ];
